              ...
              <div className="flex flex-col md:flex-row items-center gap-12">
                ...
                <div className="flex-1 relative">
                  <div className="relative w-full aspect-square max-w-lg mx-auto bg-slate-100 dark:bg-surface-dark rounded-xl overflow-hidden border border-white/10">
                    <img alt="Portrait of the creator" className="w-full h-full object-cover grayscale hover:grayscale-0 transition-all duration-700" src="images/Nischal Puri.png" />
                    {/*
